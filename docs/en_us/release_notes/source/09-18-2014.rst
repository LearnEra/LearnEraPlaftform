...
* On the **Discussions** tab, you sometimes received an error message when you clicked through the thread list quickly. This bug has been fixed. 

* In some circumstances, if a student visited a section in the courseware and then left the edX session, and that section later became unavailable, the student saw a "Page Not Found" error message when she returned to her edX session. This bug has been fixed. (LMS-6492) 

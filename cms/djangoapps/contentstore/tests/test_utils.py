...
class CourseImageTestCase(TestCase):
    ...
    def test_non_ascii_image_name(self):
        ...
        course = CourseFactory.create(course=uuid4().hex[:9], course_image=course_image)
        self.assertEquals(
    ...
    def test_spaces_in_image_name(self):
        ...
        course = CourseFactory.create(course=uuid4().hex[:9], course_image=u'before after.jpg')
        self.assertEquals(
            utils.course_image_url(course),
